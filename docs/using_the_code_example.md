...
The following example clones the "[Basic TF-M Application](https://github.com/Infineon/mtb-example-ce243005-tfm-application)" application with the desired name "TF-M" configured for the *KIT_PSC3M8_EVK* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSC3M8_EVK --app-id mtb-example-ce243005-tfm-application --user-app-name TF-M --target-dir "C:/mtb_projects"
   ```
